...
public class DatesUtil {
	...
	/**
	 * Data转为String 格式（yyyy-MM-dd HH:mm:ss）
	 */
	...
	/**
	 * String转为Data 格式（yyyy-MM-dd HH:mm:ss）
	...
	/**
	 * 获取相隔n天日期，n为负数时前n天，n为正数时后n天
	 */
	public static Date getFrontDay(int n) {
		Calendar cal = Calendar.getInstance();
		cal.set(Calendar.DATE, cal.get(Calendar.DATE) + n);	
		return cal.getTime();
	}
	/**
	 * 获取某个日期相隔n天日期，n为负数时前n天，n为正数时后n天
	 */
	public static Date getFrontDay(Date date, int n) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.set(Calendar.DATE, cal.get(Calendar.DATE) + n);
		return cal.getTime();
